...
// Επιστρέφει παίκτη, ελληνική ομάδα, ξένη ομάδα, ξένο πρωτάθλημα
// ============================================================================
...
// ============================================================================
// QUERY 4: Πρώτος σκόρερ κάθε ομάδας σε επιλεγμένο πρωτάθλημα
// ΟΡΙΣΕ το όνομα πρωταθλήματος στο compName
// ============================================================================
...
// ============================================================================
// QUERY 5: Top 10 «σκληροί» αμυντικοί σε επιλεγμένο πρωτάθλημα
// ΟΡΙΣΕ το όνομα πρωταθλήματος στο compName
// ============================================================================
...
// ============================================================================
// QUERY 6: Βασικό επιθετικό δίδυμο ομάδας (TEAMMATES) σε επιλεγμένο πρωτάθλημα
// ΟΡΙΣΕ compName και teamName
// ============================================================================
...
// ============================================================================
// QUERY 7: 3 πιο κομβικοί παίκτες ομάδας (με τους περισσότερους συμπαίκτες)
// ΟΡΙΣΕ compName και teamName
// ============================================================================
